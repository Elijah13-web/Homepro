...
import img14 from "../../assets/images/Frame 37 (5).png"
...
import img27 from "../../assets/images/Frame 87 (2).png"
...
export const featureDb = [
    ...
    {
        _id: 2,
        title: "Modern Duplex in Lekki phase 2",
        price: 450000000,
        bed: 6,
        bath: 7,
        size: 3000,
...
export const howitworksDb = [
    {
        _id: 1,
        title: "Search Properties",
        description: "Use our search tool to find Properties that match your criteria.",
        icon: icon1
    },
    {
        _id: 2,
        title: "Schedule a Visit",
        description: "Arrange a visit to see the properties in person.",
        icon: icon2
    },
    {
        _id: 3,
        title: "Make an Offer",
        description: "Submit an offer and negotiate the best deal.",
        icon: icon4
    },
    {
        _id: 4,
        title: "Close the deal",
        description: "Complete the paperwork and move into your new home.",
        icon: icon3
    },
]
...
export const agentsDb =[
    {
        ...
        number: "+2349022234561",
        image: img17
    },
    {
        _id: 2,
        title: "Agent Yeni",
        description:"Specialist in Real estate",
        number: "+2349044501181",
        image: img18
    },
    {
        _id: 3,
        title: "Agent Emeka",
        description:"Specialist in Marketing",
        number: "+2349059610001",
        image: img19
    },
    {
        _id: 4,
        title: "Agent Shatu",
        description:"Specialist in Real estate",
        number: "+2349034567591",
        image: img20
    },
]

export const LastestNewsDb=[
    {
        _id: 1,
        title: "Samuel O.",
    ...
    },
    {
        _id: 2,
        title: "Omoyeni A.",
        heading:"How to choose the right neighborhood:",
        description:"Find out what to look for in a neighborhood.",
        date:"5/08/2024",
        image: img22,
        icon:icon21,
        icon2:icon22,
...
export const blogCardDb=[
    ...
    },
    {
        _id: 7,
        title: "Chioma B.",
        heading:"Benefits of Investing in Commercial Real Estate:",
        description:"Learn the advantages of before making your move.",
        date:"31/07/2024",
        image: img27,
        icon:icon21,
        icon2:icon22,
    ...
    },
    {
        _id: 8,
        title: "Talatu T.",
        heading:"A Beginner's Guide to Real Estate Investment Trusts:",
        description:"Explore the world of REITs.",
        date:"30/07/2024",
        image: img28,
        icon:icon21,
        icon2:icon22,
...
export const SectionBDb=[
        ...
        {
            _id: 3,
            title: "Studio apartment at Abuja",
            price: 100000000,
            image: img156
        ...
        {
            _id: 4,
            title: "Comfortable Villa at Kaduna",
            price: 190000000,
            image: img157
        ...
        {
            _id: 5,
            title: "Bungalow at Port-harcourt",
            price: 350000000,
            image: img158
