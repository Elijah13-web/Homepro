  ...
  return (
    <div className="bg-gray-300 relative">
      <Wrapper>
        ...
        <div className='bg-white w-full px-4 py-6 flex justify-between items-center border-b shadow-slate-400'>
          {/* Property Image and Details */}
          <div className="flex items-center w-1/2 space-x-2">
            <img src={Image230} alt="Property" className="w-24 h-24 object-cover rounded-lg border-blue-300 "/>
            <div>
              ...
              <p className="text-1xl font-semibold text-[#9FA007]">95,000,000</p>
              </div>
            </div>
          </div>
        ...
        <div className='bg-white w-full px-4 py-6 flex justify-between items-center border-b  border-gray-300 '>
          ...
          <div className="flex items-center lg:w-1/2 space-x-2">
            ...
            <div>
              ...
              <div className='flex'>
                <img src={ngn} alt='naria' className='h-5'/>
              <p className="text-1xl font-semibold text-[#9FA007]">500,000,000</p>
              </div>
            </div>
          </div>
